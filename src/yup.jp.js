...
const jpLocale = {
  ...
  string: {
    length: (param) =>
      `${param.label}は${param.length}文字ちょうどでなければなりません。`,
    min: (param) =>
  ...
  number: {
    ...
    lessThan: (param) =>
      `${param.label}は${param.less}未満でなければなりません。`,
    moreThan: (param) =>
  ...
  date: {
    min: (param) =>
      `${param.label}は${param.min}より未来日でなければなりません。`,
    max: (param) =>
      `${param.label}は${param.max}より過去日でなければなりません。`,
  },
};
